...
public class Main {
    ...
    public static void Adelantar(){
        ...
        oFecha.add(Calendar.YEAR, f1.getAño());
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("\n\nEl IVA segun la decisión del gobierno es del "+p1.getIVA()+"%");
            ...
            System.out.print("\n\nDesearía comprar otro producto? (si/no): "); opc = in.next().charAt(0);
        }while(opc == 's' || opc == 'S');
